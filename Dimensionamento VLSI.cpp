...
int main()
{
	...
	C_GD_13 = C_ox * W_tbuff_1_p * L_tbuff_1_p;

	C_GD_14 = C_ox * W_tbuff_1_n * L_tbuff_1_n;

	C_in_tbuff = C_GS_13 + C_GS_14 + 2 * C_GD_13 + 2 * C_GD_14;
	...
	std::cout << "C_GS_13: " << C_GS_13 << " F\n";

	std::cout << "C_GS_14: " << C_GS_14 << " F\n";

	std::cout << "C_GD_13: " << C_GD_13 << " F\n";

	std::cout << "C_GD_14: " << C_GD_14 << " F\n";
